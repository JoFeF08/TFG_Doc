...
\begin{sloppypar}
La Fase~3 estudia \emph{CosMultiInput}, un \emph{feature extractor} convolucional
...
\begin{figure}[H]
  ...
  \caption{\emph{CosMultiInput}: arquitectura de dues branques. La branca CNN processa
...
\begin{table}[H]
  ...
  \begin{tabular}{llrrr}
    ...
    \bottomrule
  \end{tabular}
  \caption{Pic de \(\text{metric}\) (24M passos) per a COS amb pesos aleatoris vs \ac{MLP}.}
  \label{tab:fase3}
\end{table}
...
\begin{figure}[H]
  ...
  \caption{Pic de \(\text{metric}\) (24M passos) per protocol i agent, COS amb pesos
...
\begin{table}[H]
  ...
  \begin{tabular}{lrr}
    ...
    \bottomrule
  \end{tabular}
  \caption{Pic de \(\text{metric}\) (protocol mans, 24M passos) per als quatre règims
...
mostren l'evolució i els pics del win-rate ponderat (\(\text{metric}\)); la figura~\ref{fig:fase4-adaptacio}
...
\begin{figure}[H]
  ...
  \caption{Evolució del win-rate ponderat (\(\text{metric}\)) al llarg de l'entrenament
...
\begin{figure}[H]
  ...
  \caption{Pic de \(\text{metric}\) per a cada run, tots tallats al pressupost comú de 12M
