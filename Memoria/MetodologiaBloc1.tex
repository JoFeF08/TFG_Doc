...
\begin{table}[H]
  ...
  \caption{Comparació a 12M passos (mateix pressupost, avaluació sobre partides). El
           win-rate ponderat (\(\text{metric}\)) entrenant sobre mans és uniformement
           superior.}
  \label{tab:fase2-12m}
\end{table}
...
d'aprenentatge, i el curriculum el resol. La seva velocitat d'entrenament excel·lent
permet, a més, iterar ràpidament a les fases següents. \textbf{DQN-SB3} es manté com a \emph{baseline}
...
($\sim$17~h per execució), no supera el 60\% de \(\text{metric}\) i no mostra cap
