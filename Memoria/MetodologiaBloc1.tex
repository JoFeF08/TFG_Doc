...
\begin{table}[H]
  ...
  \begin{tabular}{lcccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{Win-rate ponderat (\(\text{metric}\)) de la Fase~1 sota les dues òptiques.
...
\begin{table}[H]
  ...
  \begin{tabular}{lrr}
    ...
    \bottomrule
  \end{tabular}
  \caption{Velocitat d'entrenament dels quatre algorismes. El paral·lelisme de PPO-SB3 el
...
\begin{figure}[H]
  ...
  \caption{Win-rate ponderat (\(\text{metric}\)) de la Fase~1 sota els dos pressupostos
...
\begin{table}[H]
  ...
  \begin{tabular}{lrrr}
    ...
    \bottomrule
  \end{tabular}
  \caption{Win-rate ponderat (\(\text{metric}\)) a 12M passos (mateix pressupost, avaluació
...
\begin{table}[H]
  ...
  \begin{tabular}{lrrr}
    ...
    \bottomrule
  \end{tabular}
  \caption{Win-rate ponderat (\(\text{metric}\)), valors finals (fi de pressupost). La
...
\begin{figure}[H]
  ...
  \caption{Corbes del \emph{curriculum} per als agents RLCard (win-rate ponderat). La línia
...
\begin{figure}[H]
  ...
  \caption{Corbes del \emph{curriculum} per als agents SB3 (win-rate ponderat). Tots dos
