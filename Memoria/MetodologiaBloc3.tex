...
L'algorisme \ac{NFSP} genera altres pesos com a la política promig (\texttt{AveragePolicyNet}),
...
\texttt{sl\_final.pt}} (Fase~6 original \(\to\) \texttt{ppo\_nfsp}; re-run \(\to\)
\texttt{ppo\_nfsp\_rerun20M}). Aquesta distinció és clau: l'\texttt{exploit\_vs\_sl}
