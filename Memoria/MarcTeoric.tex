...
\begin{table}[H]
  ...
  \begin{tabular}{lllll}
    \toprule
    \textbf{Algorisme} & \textbf{Família} & \textbf{On/Off-policy} & \textbf{Memòria} & \textbf{Ref.} \\
    \midrule
    \acs{DQN}  & Aprox.\ funcions de valor & Off-policy & Experience replay  & \cite{mnih2015dqn}      \\
    \acs{PPO}  & Actor-crític              & On-policy  & Cap                & \cite{schulman2017ppo}  \\
    \acs{NFSP} & Fictitious self-play      & Tots dos   & Reservoir buffer   & \cite{heinrich2016nfsp} \\
    \bottomrule
  \end{tabular}
\end{table}
