...
Les fases s'agrupen en tres blocs, separats per tres punts de control
(\emph{checkpoints}) que tanquen un grup d'experiments i fixen quins models continuen:
...
\begin{itemize}
  ...
  \item \textbf{Bloc 3} (secció~\ref{sec:bloc3}): robustesa i aproximació a l'equilibri
        (Fases 5--6, Checkpoint~3: model de desplegament).
\end{itemize}
